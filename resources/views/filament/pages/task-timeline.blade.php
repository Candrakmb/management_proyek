        ...
        <div class="bg-white rounded-xl shadow">
            <div class="p-4 border-b border-gray-200">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Timeline view showing task duration from start to due date
                </p>
            </div>
                                ...
                                <td class="px-4 py-4 border-r border-gray-200">
                                    <div class="flex flex-col">
                                        ...
                                        <div class="flex items-center gap-2 text-xs text-gray-500 mt-1">
                                            <span class="font-medium">{{ $task['task_id'] }}</span>
                            ...
                            <tr>
                                <td colspan="{{ count($this->getMonthHeaders()) + 1 }}" class="px-6 py-10 text-center text-sm text-gray-500">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <span>No tasks found with due dates</span>
                                        <span class="text-xs mt-1">Select a different project or add tasks with due dates</span>
                                    </div>
                                </td>
                            </tr>
                        @endif
